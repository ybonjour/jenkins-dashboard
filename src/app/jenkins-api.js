export class JenkinsApi {
  constructor(jobPath) {
    ...
    var username = "testplatform";
    var password = "testplatform!@3";
  ...
  getChangesets(buildNumber) {
    return fetch(
      this.workflowEndpoint(this.jobPath, buildNumber, "changesets"),
      {
        method: "GET",
        headers: this.headers
      }
  ...
  parseJobOverview(json) {
    return {
      ...
      lastUnsuccessfulBuild: this.numberOrDefault(
        json,
